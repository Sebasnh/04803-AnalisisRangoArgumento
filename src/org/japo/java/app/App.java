...
public final class App {
    ...
    public final void launchApp() {
         ...
         int resultadoRango = UtilesPrimitivos.analizarRango(UtilesPrimitivos.NUM,
                 UtilesPrimitivos.N_MIN, UtilesPrimitivos.N_MAX);

        System.out.println("ANÁLISIS DE RANGO");
        System.out.println("=================");
        System.out.printf("Número ......: %d%n", UtilesPrimitivos.NUM);
        System.out.println("---");
        System.out.printf("Mínimo ......: %d%n", UtilesPrimitivos.N_MIN);
        System.out.printf("Máximo ......: %d%n", UtilesPrimitivos.N_MAX);
        System.out.println("---");
